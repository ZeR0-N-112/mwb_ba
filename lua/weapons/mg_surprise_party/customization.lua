...
SWEP.Customization = {
    ...
    {"att_perk", "attachment_vm_ar_falpha_perk_soh", "attachment_vm_ar_falpha_perk_burst",
     "att_perk_fmj", "att_perk_ricochet", "att_perk_headshot"}, 
    ...
    {"att_grip", "attachment_vm_ar_falpha_angledgrip01", "attachment_vm_ar_falpha_angledgrip02", "attachment_vm_ar_falpha_stubbygrip01", 
    "attachment_vm_ar_falpha_stubbygrip02", "attachment_vm_ar_falpha_vertgrip01", "attachment_vm_ar_falpha_vertgrip02", 
    "attachment_vm_ar_falpha_vertgrip03", "attachment_vm_ar_falpha_bipodgrip"},
}
