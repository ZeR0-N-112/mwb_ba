...
SWEP.Animations = {
    ...
    ["Equip_Railcrust"] = {
        Sequences = {"draw_first_railcrust"},
        Length = 1.35,
        Fps = 30,
        NextSequence = "Idle",
        Events = {
    ...
    ["Reload_Fast_Railcrust"] = {
        Sequences = {"Reload_Fast_Railcrust"},
        Length = 1.7,
        Fps = 30,
        MagLength = 1.1,
        NextSequence = "Idle",
    ...
    ["Reload_Empty_Railcrust"] = {
        Sequences = {"reload_empty_railcrust"},
        Length = 2.8,
        Fps = 30,
        MagLength = 1.55,
        NextSequence = "Idle",
    ...
    ["Reload_Empty_Fast_Railcrust"] = {
        Sequences = {"Reload_Empty_Fast_Railcrust"},
        Length = 2.05,
        Fps = 30,
        MagLength = 1,
        NextSequence = "Idle",
