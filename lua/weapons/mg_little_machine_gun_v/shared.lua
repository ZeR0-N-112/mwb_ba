...
SWEP.PrintName = "Little Machine Gun V"
SWEP.Category = "Modern Warfare - Blue Archive"
SWEP.SubCategory = "Specials"
SWEP.Spawnable = true
SWEP.AdminOnly = true
SWEP.VModel = Model("models/zeron/weapons/v_little_machine_gun_v.mdl")
...
SWEP.Primary.ClipSize = 145
SWEP.Primary.Automatic = true
SWEP.Primary.BurstRounds = 1
SWEP.Primary.BurstDelay = 0
SWEP.Primary.RPM = 1450
...
SWEP.Bullet = {
    Damage = {40, 35}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range
    EffectiveRange = 30, --in meters, damage scales within this distance
    Range = 120, --in meters, after this distance the bullet stops existing
